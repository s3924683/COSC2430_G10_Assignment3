...
router.route("/signin").get(async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            ...
            return res.render('userSignin', { message: 'Invalid username or password' });
        }
        ...
        res.render('userSignin', { message: 'An error occurred. Please try again later.' });
    }
});
...
router.route("/signup").get(async (req, res) => {
    ...
    try {
        ...
        if (existingUser) {
            return res.render('userSignup', { message: 'Username is already taken' });
        }
